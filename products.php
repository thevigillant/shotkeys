        ...
        <?php foreach ($products as $p): ?>
          <div class="col">
            <div class="product-card h-100">
              ...
              <div style="position: relative; height: 220px; overflow: hidden; border-bottom: 1px solid rgba(255,255,255,0.1); background: rgba(0,0,0,0.2); display: flex; align-items: center; justify-content: center;">
                  ...
                  <img
                    ...
                    loading="lazy"
                    class="card-img-top"
                    style="max-width: 100%; max-height: 100%; width: auto; height: auto; object-fit: contain; padding: 10px;"
                  />
              </div>
              ...
              <div class="card-body d-flex flex-column">
                ...
                <div class="mt-auto pt-3 border-top border-secondary">
                    ...
                    <?php elseif ($p['type'] === 'RANDOM_BOX'): ?>
                      ...
                      <a href="javascript:void(0)" class="btn btn-custom w-100 js-add-cart" data-id="<?= $p['id'] ?>" style="position: relative; z-index: 1000;">
                        Tentara a Sorte (Add +)
                      </a>
                    ...
                    <?php else: ?>
                      ...
                      <a href="javascript:void(0)" class="btn btn-custom w-100 d-flex justify-content-between align-items-center js-add-cart" data-id="<?= $p['id'] ?>" style="position: relative; z-index: 1000;">
                        <span>Adicionar +</span>
