...
<head>
  ...
  <style>
    /* Estilos específicos para centralizar o login */
    body {
      display: flex;
...
<div class="login-wrapper">
  <div class="login-card">
    <div class="text-center mb-4">
      ...
      <p class="text-white opacity-75">Bem-vindo de volta</p>
    </div>
    ...
    <form method="post">
      ...
      <div class="d-grid gap-2 mb-3">
        <button type="submit" class="btn btn-custom btn-lg w-100">ENTRAR</button>
      </div>
      
      <div class="text-center">
        <span class="text-white opacity-75">Ainda não tem conta?</span> 
        <a href="register.php" class="text-decoration-none fw-bold" style="color: var(--color-accent);">Criar conta</a>
      </div>
    </form>
  </div>
</div>
